...
EVENT_DIM_QUERY =   """
                    SELECT e.event_id, at.attack_type, ei.success, ei.suicide, wt.weapon_type, ei.individual, ei.nperps, ei.nperps_cap, ei.host_kid, 
                            ...
                            ei.perps_killed, ei.total_wounded, ei.perps_wounded, ei.property_dmg_value, cp.population, cop.population
                    FROM odb.event_info AS ei
                        INNER JOIN
...
FACT_QUERY =        """
                    ...
                    GROUP BY ei.event_id, at.group_name, tt.target, d.year, d.month, d.day, co.region, p.country, c.provstate, ei.city
                    """ 
